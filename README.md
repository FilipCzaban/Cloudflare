...
1. Vytvoř nový repozitář na [github.com/new](https://github.com/new)
2. Nahraj soubory:
   ```bash
   git init
   git add index.html style.css og-image.png README.md
   git commit -m "Cloudflare info page"
   git remote add origin https://github.com/TVOJE_JMENO/cloudflare-page.git
   git push -u origin main
   ```
3. Jdi na **Settings → Pages → Source → Deploy from a branch → main / root**
4. Stránka bude dostupná do ~1 minuty

---

## 📚 Zdroje

- [Cloudflare.com](https://www.cloudflare.com) — oficiální dokumentace
- Wikipedia — Cloudflare
- Vlastní výzkum + AI asistence
